    ...
    */
    ...
    private XWikiDocument initCollectionSettings(String fullName, String pageTitle, String space, XWikiContext context) throws XWikiException {
        ...
        if (doc.getName().equals(Constants.DEFAULT_COLLECTION_PAGE)){
            ...
            obj.setDBStringListValue("trainedTopicsAndCompetencies", Collections.EMPTY_LIST);
            obj.setDBStringListValue("eduLevelFine", Collections.EMPTY_LIST);
        ...
        context.getWiki().saveDocument(doc, context.getMessageTool().get("curriki.comment.initmetadatafornewcollection"), true, context);
        return doc;
    }
    ...
    public Document updateMetadata(String fullName, boolean fromTemplate) throws XWikiGWTException {
        try {
            ...
            context.getWiki().saveDocument(doc, context.getMessageTool().get("curriki.comment.initmetadatafornewasset"), true, context);
    ...
    public Document createCompositeAsset(String space, String parent, String pageName, String compositeAssetType, long position) throws XWikiGWTException {
        try {
            ...
            context.getWiki().saveDocument(doc, context.getMessageTool().get("curriki.comment.startcreatingcompositeasset"), true, context);
    ...
    private boolean insertDirectionBlock(String compositeAssetPage, long position) throws XWikiGWTException {
        try {
            ...
            context.getWiki().saveDocument(compositeAssetDoc, context.getMessageTool().get("curriki.comment.adddirectionblock"), true, context);
    ...
    public void applyRightsPolicy(String assetName) throws XWikiGWTException {
        try {
            ...
            context.getWiki().saveDocument(assetDoc, context.getMessageTool().get("curriki.comment.applyrights"), true, context);
        } catch (Exception e) {
            throw getXWikiGWTException(e);
        }
    }
    ...
    private XWikiDocument createSourceAsset(String compositeAssetPage, String space, String pageName, XWikiContext context) throws XWikiException, XWikiGWTException {
        ...
        if (compositeAssetDoc.getObject(Constants.ASSET_CLASS) != null) {
            ...
            copyProperty(parentObjAsset, newObjAsset, "eduLevelFine");
            copyProperty(parentObjAsset, newObjAsset, "trainedTopicsAndCompetencies");
        }
        ...
        context.getWiki().saveDocument(assetDoc, context.getMessageTool().get("curriki.comment.createnewsourceasset"), true, context);
    ...
    private XWikiDocument createSourceAssetFromTemplate(String templatePageName, String compositeAssetPage, String space, String pageName, boolean clearattachments, XWikiContext context) throws XWikiException, XWikiGWTException {
        ...
        if (compositeAssetDoc.getObject(Constants.ASSET_CLASS) != null) {
            ...
            mergeProperty(parentObjAsset, newObjAsset, "eduLevelFine");
            mergeProperty(parentObjAsset, newObjAsset, "trainedTopicsAndCompetencies");
        ...
        protectPage(assetDoc, context);
        context.getWiki().saveDocument(assetDoc, context.getMessageTool().get("curriki.comment.createnewsourceassetfromtemplate"), true, context);
        return assetDoc;
    }
    ...
    public String duplicateTemplateAsset(String parentAsset, String templatePageName, long index) throws XWikiGWTException {
        try {
            ...
            if (replaceSubAsset(compositeAssetDoc, templatePageName, newAssetDoc.getFullName(), index)==false) {
                ...
                context.getWiki().saveDocument(compositeAssetDoc, comment, true, context);
    ...
    public void updateAssetMetadata(String assetPage, Map formMap) throws XWikiGWTException {
        try {
            ...
            assetObj.set("eduLevelFine", getFieldValue(formMap, Constants.ASSET_CLASS, "eduLevelFine"), context);
            assetObj.set("trainedTopicsAndCompetencies", getFieldValue(formMap, Constants.ASSET_CLASS, "trainedTopicsAndCompetencies"), context);
            ...
            // intergeo extra fields
            assetObj.set("eduLevelFine", getFieldValue(formMap, Constants.ASSET_CLASS, "eduLevelFine"), context);
            assetObj.set("trainedTopicsAndCompetencies",
                    getFieldValue(formMap, Constants.ASSET_CLASS, "trainedTopicsAndCompetencies"), context);

            // if (log.isDebugEnabled())
            //  log.debug("Category: " + getFieldValue(formMap, Constants.ASSET_CLASS, Constants.ASSET_CATEGORY_PROPERTY));
            ...
            context.getWiki().saveDocument(assetDoc, context.getMessageTool().get("curriki.comment.updatemetadata"), true, context);
    ...
    public Document createTextSourceAsset(String compositeAssetPage, long type) throws XWikiGWTException {
        try {
            ...
            context.getWiki().saveDocument(assetDoc, context.getMessageTool().get("curriki.comment.createtextsourceasset"), true, context);
    ...
    public Document createLinkAsset(String compositeAssetPage, String link) throws XWikiGWTException {
        try {
            ...
            context.getWiki().saveDocument(assetDoc, context.getMessageTool().get("curriki.comment.createlinksourceasset"), true, context);
    ...
    public Document updateViditalk(String fullName, String videoId) throws XWikiGWTException {
        try {
            ...
            context.getWiki().saveDocument(doc, context.getMessageTool().get("curriki.comment.updatedviditalkid"), (videoObj==null), context);
