...
public class Constants {
    ...
    public static final String CURRIKI_SERVICE = "/xwiki/CurrikiService";
    ...
    public static final String ASSET_HIDE_FROM_SEARCH_PROPERTY = "hidden_from_search";
    ...
    public static final String GROUP_COLLECTION_SPACE_PREFIX = GROUP_COLLECTION_PREFIX_SPACE_PREFIX +GROUP_SPACE_PREFIX;
    ...
    public static final String SUPPORTED_MIMETYPES_ICONS_STRING = 
        ...
        ";HTTP;IHA;IZH;JPG;MOV;MP3;MPG;NOTEBOOK;PDF;PHP;PNG;PPT;PSD;RTF;SCO;SOS;SWF" +
