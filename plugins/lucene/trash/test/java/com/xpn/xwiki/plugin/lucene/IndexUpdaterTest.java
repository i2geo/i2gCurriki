 ...
 * 
 * @version $Id: IndexUpdaterTest.java 28812 2010-05-10 17:03:03Z tmortagne $
 */
public class IndexUpdaterTest extends AbstractXWikiComponentTestCase
{
    ...
    {
        TestIndexUpdater(FSDirectory directory, int indexingInterval, int maxQueueSize, LucenePlugin plugin,
            XWikiContext context) throws Exception 
        {
            super();
            super.directory = directory;
            super.setIndexProfile(new I2GLuceneProfile());
    ...
    protected void setUp() throws Exception
    {
        ...
        this.loremIpsum = new TestXWikiDocument("Lorem", "Ipsum");
        ...
        this.mockXWiki.stubs().method("getDocument").with(eq(this.loremIpsum.getFullName()), ANYTHING).will(
    ...
    public void testCreateIndex() throws Exception
    {
        ...
        while(indexRebuilder.rebuildInProgress) {
            Thread.sleep(20);
        }
    ...
    public void testIndexUpdater() throws Exception
    {
        ...
        new TestIndexRebuilder(indexUpdater, getContext());
        ...
        indexUpdater.add((XWikiDocument) this.loremIpsum.clone(), getContext());
        indexUpdater.add((XWikiDocument) this.loremIpsum.clone(), getContext());
    ...
    public void dontTestLock() throws Exception
    {
        FSDirectory directory;
        File f = new File(INDEXDIR);
        int indexingInterval;
